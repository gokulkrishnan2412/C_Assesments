...
Input:./25my_cat.c
Output: /my_cat file1.txt file2.txt file3.txt
...
int main(int argc, char **argv)
{
    ...
    {
        printf("Usage: ./25my_cat file1.txt file2.txt\n Or\n");
        printf("Usage: ./25my_cat file1.txt file2.txt file3.txt\n Or\n");
        printf("Usage: ./25my_cat \n");
        return -1;
    }
